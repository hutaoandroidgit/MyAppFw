...
import com.hutao.myappfw.constant.MMKVKey;
 ...
 * @ProjectName: MyAppFw
 * @Package: com.hutao.myappfw.persistence
 * @ClassName: FwKeyValue
 * @Description: 本类为MMKV的封装类，防止代码入侵 ，提供持久化方法 替代Sharepreferences
 * @Author: hutao
 * @CreateDate: 2021/10/22 14:58
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/10/22 14:58
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public final class FwKeyValue {
    public static final String TAG = "FwMMKV";
